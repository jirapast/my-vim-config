...
# mode disabled # disable automatic updates zstyle ':omz:update' mode auto # update automatically 
# without asking zstyle ':omz:update' mode reminder # just remind me to update when it's time

# Uncomment the following line to change how often to auto-update (in days). zstyle ':omz:update' 
# frequency 13
...
# can be placed here, though oh-my-zsh users are encouraged to define aliases within the 
# ZSH_CUSTOM folder. For a full list of active aliases, run `alias`.
#
...
# The next line updates PATH for the Google Cloud SDK.
#if [ -f '/home/tn/google-cloud-sdk/path.zsh.inc' ]; then . 
#'/home/tn/google-cloud-sdk/path.zsh.inc'; fi
#
### The next line enables shell command completion for gcloud.
#if [ -f '/home/tn/google-cloud-sdk/completion.zsh.inc' ]; then . 
#'/home/tn/google-cloud-sdk/completion.zsh.inc'; fi
#
